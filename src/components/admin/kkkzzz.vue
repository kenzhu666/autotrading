<template>
        <Layout>
                ...
                <div class='sm'>
                    <Row class='part-sm'>
                        ...
                        <Row :gutter='36'>
                            ...
                            <Col span='12' class='col-sm'>
                            <p>品牌</p>
                                <Input v-model="brand" placeholder="请输入..."/>
                            </Col>
                    ...
                    <Row class='part-sm'>
                        ...
                        <Row :gutter='36'>
                                ...
                                <Col span='12' class='col-sm'>
                                <p>折扣$:</p>
                                    <Input v-model="discount" placeholder="请输入..."/>
                                </Col>
            ...
            <Footer class = "layout-footer-center"><footer1></footer1></Footer>
...
import footer1 from '@/components/footer1';
    ...
    export default{
        ...
        this.axios({method: 'post', url:'/static/postNew.php', data:postData})
        .then(res => {
